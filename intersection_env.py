...
class MultiTaskIntersectionEnv(gym.Env):
    ...
    def _get_observation(self):
        ...
        return obs_vector
# array_copy_trial_0 = [x for x in obs]
# array_copy_trial_1 = [x for x in obs]
# array_copy_trial_2 = [x for x in obs]
# array_copy_trial_3 = [x for x in obs]
# array_copy_trial_4 = [x for x in obs]
# array_copy_trial_5 = [x for x in obs]
# array_copy_trial_6 = [x for x in obs]
# array_copy_trial_7 = [x for x in obs]
# array_copy_trial_8 = [x for x in obs]
# array_copy_trial_9 = [x for x in obs]
# array_copy_trial_10 = [x for x in obs]
# array_copy_trial_11 = [x for x in obs]
# array_copy_trial_12 = [x for x in obs]
# array_copy_trial_13 = [x for x in obs]
# array_copy_trial_14 = [x for x in obs]
# array_copy_trial_15 = [x for x in obs]
# array_copy_trial_16 = [x for x in obs]
# array_copy_trial_17 = [x for x in obs]
# array_copy_trial_18 = [x for x in obs]
# array_copy_trial_19 = [x for x in obs]
# array_copy_trial_20 = [x for x in obs]
# array_copy_trial_21 = [x for x in obs]
# array_copy_trial_22 = [x for x in obs]
# array_copy_trial_23 = [x for x in obs]
# array_copy_trial_24 = [x for x in obs]